...
public static class ResultExtensions
{
    public static ActionResult ToActionResult<T>(this Result<T> result)
    {
        ...
        return result switch
        {
            ...
            { IsSuccess: false, ErrorType: ErrorType.Conflict } => new ObjectResult(result.ErrorMessage) { StatusCode = StatusCodes.Status409Conflict },
            { IsSuccess: false, ErrorType: ErrorType.TooManyRequests } => new ObjectResult(result.ErrorMessage) { StatusCode = StatusCodes.Status429TooManyRequests },
